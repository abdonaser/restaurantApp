    ...
    <div className=".row contact-head">
        ...
        <div className="row pt-3">
            <div className="col-lg-6 col-12 contact-info">
              ...
              <a href=""><h6>01550406840</h6></a>
                </div><div className="email social">
                <i class="fa-solid fa-envelope"></i>
             <a href=""> <h6>contact@gmail.com</h6></a>
                </div>
                <div className="location social">
                <i class="fa-solid fa-location-dot"></i>
             <a href=""> <h6> 203, Envato Labs, Behind Alis Steet, Australia</h6></a>
                </div>
            ...
            <div className="col-lg-6 col-12 form-contact">
                ...
                <textarea rows={5} name="Enter your message" id="">Enter your message</textarea>
